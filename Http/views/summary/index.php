...
?>
    <section class="bg-white py-8 antialiased dark:bg-gray-900 md:py-16">
        <form action="#" class="mx-auto max-w-screen-xl px-4 2xl:px-0 flex flex-col justify-center items-center">
                    ...
                    <div class="main-box border border-gray-200 rounded-xl pt-6 max-w-xl max-lg:mx-auto lg:max-w-full">
                        ...
                        <div class="w-full px-3 min-[400px]:px-6">
                            <div class="flex flex-col lg:flex-row items-center py-6 border-b border-gray-200 gap-6 w-full">
                                <div class="img-box max-lg:w-full">
                                    <img src="/public/images/product-1.avif" alt="Premium Watch image"
                                        ...
                                        <div class="flex items-center">
                                            <div class="">
                                                <h2 class="font-semibold text-base text-black mb-1">
                                                    Curry 12 'Wardell Mode' Basketball Shoes</h2>
                                                <p class="font-normal text-xs text-gray-500 mb-1">
                                                    What's Wardell Mode? It's that look in #30's eyes when he's going off.</p>
                                                <div class="flex items-center ">
                                        ...
                                        <div class="grid grid-cols-5">
                                            <div class="col-span-5 lg:col-span-1 flex items-center max-lg:mt-3">
                                                <div class="flex gap-3 lg:block">
                                                    ...
                                                    <p class="lg:mt-4 font-medium text-sm leading-7 text-orange-600">₱100</p>
                                                </div>
                                            </div>
                                            <div class="col-span-5 lg:col-span-2 flex items-center max-lg:mt-3 ">
                                                <div class="flex gap-3 lg:block">
                                                    <p class="font-medium text-sm leading-7 text-black">Status</p>
                                                    <p class="font-medium text-sm leading-6 whitespace-nowrap py-0.5 px-3 rounded-full lg:mt-3 bg-emerald-50 text-emerald-600">New</p>
                                                </div>
                        ...
                        <div class="w-full border-t border-gray-200 px-6 flex flex-col lg:flex-row items-center justify-between ">
                            <div class="flex flex-col sm:flex-row items-center max-lg:border-b border-gray-200">
                                ...
                                <p class="font-medium text-base text-gray-900 pl-6 py-3 max-lg:text-center">Paid using Credit Card <span class="text-gray-500">ending with 8822</span></p>
                            </div>
                            <p class="font-semibold text-base text-black py-6">Total Price: <span class="text-orange-600"> ₱200.00</span></p>
                        </div>
