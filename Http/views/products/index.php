            ...
            <section class="antialiased dark:bg-gray-900">
                <div class="mx-auto max-w-screen-xl px-4 2xl:px-0">
                    ...
                    <div class="flex flex-col items-center">
                        <span class="text-sm text-gray-700 dark:text-gray-400">Showing <span class="font-semibold text-gray-900 dark:text-white">1</span> to <span
                                    class="font-semibold text-gray-900 dark:text-white">8</span> of <span
                                    class="font-semibold text-gray-900 dark:text-white">8</span> Entries</span>
                        <div class="inline-flex mt-2 xs:mt-0 gap-x-1">
                            <button class="flex items-center justify-center px-5 h-10 text-sm rounded-sm font-medium text-neutral-800 bg-neutral-200 hover:bg-gray-300">
                                Prev
                            </button>
                            <button class="flex items-center justify-center px-5 h-10 text-sm rounded-sm font-medium text-neutral-800 bg-neutral-200 hover:bg-gray-300">
                                Next
