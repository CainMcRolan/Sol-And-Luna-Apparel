            ...
            <section class="antialiased dark:bg-gray-900">
                <div class="mx-auto max-w-screen-xl px-4 2xl:px-0">
                                                ...
                                                <div class="flex items-center justify-end gap-1">
                                                    ...
                                                    <form action="/wishlist" method="POST">
                                                        ...
                                                        <button
                                                            ...
                                                            <svg class="h-5 w-5 <?= in_array($product['product_id'], $wishlist) ? 'fill-orange-500 stroke-orange-500' : 'stroke-current' ?>" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                    ...
                    <div class="flex flex-col items-center">
                        <span class="text-sm text-gray-700 dark:text-gray-400">Showing <span class="font-semibold text-gray-900 dark:text-white"><?= min($product_count, $page * 8 + 1) ?></span> to <span
                                    class="font-semibold text-gray-900 dark:text-white"><?= min($product_count, ($page + 1) * 8) ?></span> of <span
                        ...
                        <div class="inline-flex mt-2 xs:mt-0 gap-x-1">
                            <button @click="window.location.href = '<?= parse_url($_SERVER['REQUEST_URI'], PHP_URL_PATH) . '?page=' . $page - 1 ?>'" <?= $_GET['page'] ?? false ? '' : 'disabled' ?> class="<?= $_GET['page'] ?? false ? 'hover:bg-gray-300' : 'opacity-25 cursor-not-allowed' ?> bg-neutral-200 flex items-center justify-center px-5 h-10 text-sm rounded-sm font-medium text-neutral-800">
                                Prev
                            </button>
                            <button @click="window.location.href = '<?= parse_url($_SERVER['REQUEST_URI'], PHP_URL_PATH) . '?page=' . $page + 1 ?>'" <?= checkPage($product_count) ? '' : 'disabled' ?>  class="<?= checkPage($product_count) ? 'hover:bg-gray-300' : 'opacity-25 cursor-not-allowed' ?> flex items-center justify-center px-5 h-10 text-sm rounded-sm font-medium text-neutral-800 bg-neutral-200 hover:bg-gray-300">
                                Next
                            </button>
                        </div>
                    </div>
