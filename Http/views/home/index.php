...
?>
    ...
    <div class="w-full h-[calc(100svh-100px)] sm:h-fit mb-8 sm:mb-16">
        ...
        <div class="flex w-full flex-col items-center justify-center">
            <p class="mt-6 text-sm font-medium sm:text-md sm:mt-10 sm:font-semibold lg:mt-4 2xl:mt-6">UA Holiday Gift Guide '24</p>
    ...
    <div x-data="{ scrollLeft: 0 }" class="relative mb-12 w-full bg-white px-4 lg:w-[90%] 2xl:w-[60%]" data-aos="fade-left" data-aos-duration="1000">
    ...
    <div class="mt-12 mb-8 w-full bg-white 2xl:w-[70%]">
        <img src="/public/images/football.avif" alt="" class="sm:h-[50svh] sm:w-full sm:object-cover">
