<aside class="text-neutral-800">
    <div class="flex py-2 gap-x-2">
        <a href="/dashboard" class="block  text-base hover:underline">Dashboard</a>
    </div>
    <div class="flex py-2 gap-x-2">
        <a href="/order-history" class="block  text-base hover:underline">Order History</a>
    </div>
    <div class="flex py-2 gap-x-2">
        <a href="/profile" class="block  text-base hover:underline">Profile</a>
    </div>
    <div class="flex py-2 gap-x-2">
